<div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
    <div class="mb-3 mb-sm-0">
        <h5 class="card-title fw-semibold">Table {{ $title_c }}</h5>
    </div>
</div>
        ...
        <tbody>
            @foreach ($datas as $item)
                <tr>
                    ...
                    <td>{!! Str::limit($item->open_price, 20) !!}</td>
                    <td>{!! Str::limit($item->product_weight, 20) !!}</td>
                    <td>{!! Str::limit($item->product_quality, 20) !!}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
