                ...
                <div class="card-body">
                    <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                        <div class="mb-3 mb-sm-0">
                            <h5 class="card-title fw-semibold">Update Table Information Management</h5>
                        </div>
                    </div>
                    <div>
                        <form id="formInsert" enctype="multipart/form-data" method="post"
                            action="{{ route('information.update', $data->id) }}">
                            @method('patch')
                            @csrf
                            <div class="mb-3 row">
                            ...
                            <div class="float-end">
                                <a href="/information" class="btn btn-outline-dark me-2">Cancel</a>
