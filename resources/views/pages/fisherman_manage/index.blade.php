            ...
            <div class="card w-100">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <a href="/fisherman/create" class="text-decoration-none btn btn-outline-dark mb-3"><i
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        <td class="action-links">
                                            <a href="{{ route('fisherman.edit', $item->id) }}"
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="moreActionsDropdown">
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('fisherman.show', $item->id) }}"><i
                                                                class="ti ti-info-circle me-1 text-black"></i>Detail</a>
                                                    </li>
                                                    <form id="formDelete" method="post"
                                                        action="{{ route('fisherman.destroy', $item->id) }}">
                                                        @method('delete')
                                                        @csrf
